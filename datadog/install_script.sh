...
restart_cmd="$sudo_cmd $service_cmd datadog-agent stop; pkill -15 agent ||true; $sudo_cmd $service_cmd datadog-agent start||true"
stop_instructions="$sudo_cmd $service_cmd datadog-agent stop; pkill -15 agent ||true"
